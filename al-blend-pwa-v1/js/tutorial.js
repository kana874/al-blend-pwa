(function(root){
  ...
  const steps=[
    ...
    {title:'3. 天秤分解能を反映',body:'理論添加量だけでなく、登録した天秤分解能に基づく下側・最近傍・上側の秤量候補と、そのときの予想最終濃度を確認できます。'},
    ...
    {title:'準備完了',body:'「サンプル入力」を使うと、Al 500 kg / Cu 2→50 ppm / 5N Cu / 歩留まり95%の例をすぐ試せます。'}
  ];
  let idx=0;
